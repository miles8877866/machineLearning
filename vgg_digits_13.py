...
train_data, train_label = load_data(r'C:/Users/as722/Desktop/tests/poker_data_digit13/training/')
data = np.zeros([52, 96, 71, 3])

for i in range(3):
    data[:,:,:, i] = train_data
label = np.eye(13)[train_label]  
...
model.compile(optimizer='adam',
              ...
              metrics=['accuracy'])
a = model.fit(data, label, batch_size=5, epochs=100, shuffle = True, callbacks = my_callbacks)
