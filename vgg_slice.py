...
train_data, train_label = load_data(r"C:/Users/as722/Desktop/tests/pca_for_slice/train/")
data = np.zeros([36, 96, 71, 3])
t_data = np.zeros([16, 96, 71, 3])
test_data, test_label =  load_data(r"C:/Users/as722/Desktop/tests/pca_for_slice/test/")
for i in range(3):
    data[:,:,:, i] = train_data
for i in range(3):
    t_data[:,:,:, i] = test_data  
...
model.compile(optimizer='adam',
              ...
              metrics=['accuracy'])
# a = model.fit(data, label, batch_size=4, epochs=50, shuffle = True, callbacks = my_callbacks)

predict = model.evaluate(t_data, test_label)
